...
export const BookOpenIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 14v-4.707a1 1 0 01.293-.707l6-6a1 1 0 011.414 0l6 6a1 1 0 01.293.707V19a2 2 0 01-2 2h-1a2 2 0 01-2-2v-1a2 2 0 00-2-2h-2a2 2 0 00-2 2v1a2 2 0 01-2 2h-1a2 2 0 01-2-2V14z" />
    </svg>
);
...
export const BarChart2Icon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 20V10M18 20V4M6 20V16" />
    </svg>
);
